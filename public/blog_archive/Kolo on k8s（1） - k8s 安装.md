## Kolo on k8s（1） - k8s 安装

本系列教程的主要目标是，以生产的规格部署 k8s，并成功的把 Kolo 部署到 k8s。对于 k8s 的使用不会做过多的讲解，因为网上的资源已经很丰富了，所以着重讲解如何让 Spark 跑在 k8s 上，如何让 Kolo 跑在 k8s 上，一步一步细致讲解，按照步骤做 100% 保证完美运行，全网首发！
